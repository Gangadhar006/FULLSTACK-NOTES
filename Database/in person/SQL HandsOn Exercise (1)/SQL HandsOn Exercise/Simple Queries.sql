...
select count(salary) as [count] from empsalary where ispermanent='yes' and salary > 2500
...
select count(empid) as [employee count], projectid from empproject group by projectid

--  9.  How many project not started in year 2010.
